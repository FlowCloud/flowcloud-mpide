/*******************************************************************************
  ...
  Summary:
    The Flow starter-app version of the HTTP web server module together with a
	file system (SYS_FS) allow the board to act as a web server.
...
#ifndef __HTTP_STARTERAPP_H_
#define __HTTP_STARTERAPP_H_
...
typedef enum
{
	...
	HTTP_FORBIDDEN,              // 403 Forbidden will be returned
    ...
    HTTP_POSTBODY_INIT,          // Starting reception of a POST body
	HTTP_POSTBODY_RX,			 // Currentlyt receiving a POST body
    HTTP_POSTBODY_OK,            // Received a POST body ok
    HTTP_POSTBODY_ERROR,         // Encountered an error when recieving a POST body
...
/*****************************************************************************
  ...
  Description:
    Returns the handle of the current HTTP connection file.
...
/*****************************************************************************
  ...
  Description:
    Returns the POST state machine state for the connection defined by connHandle.
...
/*****************************************************************************
  ...
  Description:
    Sets the POST state machine state for the connection defined by connHandle.
    This state is maintained by the HTTP connection and can be used by the user of the
    HTTP to maintain its own POST state machine.
    The values of the POST state machine have significance only for the user of the HTTP connection.
...
/*****************************************************************************
  ...
  Description:
    Returns  a pointer to the HTTP connection internal data buffer.
...
/*****************************************************************************
  ...
  Description:
    This function will returns the current value of the callback position indicator
...
/*****************************************************************************
  ...
  Description:
    The function will get the value of the "cookies or get arguments" present.
...
/*****************************************************************************
  ...
  Description:
    The function sets the value of the "cookies or get arguments" present.
...
/*****************************************************************************
  ...
  Summary:
    Get the authorized state for the current connection.

  Description:
    Returns the authorization status for the current HTTP connection.
...
/*****************************************************************************
  ...
  Description:
    This function will return the number of active HTTP connections at the current time.
  ...
  <code>
    ...
    nConns = TCPIP_HTTP_ActiveConnectionCountGet();
  </code>
...
/*****************************************************************************
  Function:
    bool TCPIP_HTTP_HasPostBody(int32_t endpointID)

  Summary:
    Determine whether the endpoint associated with the specified endpoint ID should expect a POST body.
  ...
  Parameters:
    endpointID  - the index of the endpoint to check (index into wsAllEndpoints[])

  Return Values:
    true - endpoint normally expects an HTTP POST body
    false- endpoint does not expect an HTTP POST body
...
/*****************************************************************************
  Function:
    uint32_t TCPIP_HTTP_GetEndpointCount(void)

  Summary:
    Return the number of supported endpoints.
...
/*****************************************************************************
  Function:
    uint8_t* TCPIP_HTTP_GetEndpoint(int32_t endpointID)

  Summary:
    Return a string comtaining the endpoint with the specified index.
...
/*****************************************************************************
  ...
  Description:
    ...
    will indicate the number of bytes remaining to be received before the browser request is complete.
...
/*****************************************************************************
  ...
  Description:
    ...
    in any of the TCPIP_HTTP_GetExecute, TCPIP_HTTP_PostExecute, or TCPIP_HTTP_Print_varname callbacks.
...
/*****************************************************************************
  ...
  Remarks:
    ...
    callbackPos or the connection data buffer for storage associated with individual requests.
 */
void TCPIP_HTTP_Print_varname(HTTP_CONN_HANDLE connHandle,  uint16_t wParam1, uint16_t wParam2, ...);


#endif  // __HTTP_STARTERAPP_H_
